...
SESSION_ID: process.env.SESSION_ID === undefined ? 'VAJIRA-MD=GIcQXJZY#Xx4bNeHgpkjMdhgOGByZUY4ibmUsHQje5aKTVfPjqvM' : process.env.SESSION_ID,
OWNER_NUMBER: process.env.OWNER_NUMBER === undefined ? '94768715921' : process.env.OWNER_NUMBER,   
